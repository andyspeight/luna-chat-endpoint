...
| **Luna-Chat-Staff-Guide.pdf** | Internal Travelgenix staff | Architecture, onboarding a client, widget connect/deploy, every env var, file‑sharing &amp; WhatsApp provisioning, the knowledge pipeline &amp; review, monitoring, a go‑live checklist and troubleshooting. |
