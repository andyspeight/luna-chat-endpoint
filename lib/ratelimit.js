...
module.exports = {
  ...
  // Raw Redis access, for callers that need more than a counter — the recall
  // code store needs SET with a TTL, GET and DEL. Exposed here rather than
  // opening a second Upstash client, so retries, timeouts and the fail-open
